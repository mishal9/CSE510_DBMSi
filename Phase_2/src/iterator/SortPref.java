	...
	*/
            ...
            Exception
    {
        ...
        while (true) {
            ...
            comp_res = TupleUtils.CompareTupleWithTuplePref(cur_node.tuple, _in , lastElem, _in, n_cols, _str_sizes, _pref_list, _pref_list_length);  // need tuple_utils.java
	...
	*/
            ...
            Exception
    {
        if (first_time) {
            ...
            // generate runs
            Nruns = generate_runs(max_elems_in_heap, _in[0], sortFldLen);
