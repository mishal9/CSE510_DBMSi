 ...
 */
public class ClBTLeafPage extends BTLeafPage {
   ...
   */
  public ClBTLeafPage(PageId pageno, int keyType) 
    throws IOException, 
   ...
   *@exception ConstructPageException BTLeafPage constructor error
   */
  public ClBTLeafPage(Page page, int keyType) 
    throws IOException, 
	   ConstructPageException
    {
      super(page, keyType);
...
/**new a page, associate the BTLeafPage instance with the Page instance,
   ...
   *@exception ConstructPageException BTLeafPage constructor error
   */
  public ClBTLeafPage( int keyType) 
    throws IOException, 
	   ConstructPageException
    {
      super(keyType);
   ...
   */
  public boolean redistribute(ClBTLeafPage leafPage, ClBTIndexPage parentIndexPage,
