 ...
 * key and data abstraction.  The ClBTLeafPage and ClBTIndexPage code
 ...
 *
 */
public class ClBT  implements GlobalConst{
	...
	/** 
	 * used for debug: to print a page out. The page is either ClBTIndexPage,
	 * or ClBTLeafPage. 
			...
			InvalidFrameNumberException
	{
		...
		if ( sortedPage.getType()==NodeType.INDEX ) {
			ClBTIndexPage indexPage=new ClBTIndexPage((Page)sortedPage, keyType);
			System.out.println("");
			...
			ClBTLeafPage leafPage=new ClBTLeafPage((Page)sortedPage, keyType);
			System.out.println("");
